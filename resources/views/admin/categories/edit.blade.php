...
@section('title', 'Edit Category | Shendy')
...
<div class="mb-5">
    ...
    <h1 class="display-5 fw-800 mb-2">Edit Category</h1>
    <p class="text-muted">Update the classifications for your product catalog.</p>
</div>
            ...
            <form action="{{ route('admin.categories.update', $category->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" class="form-control form-control-lg border-2 shadow-none" 
                           placeholder="e.g. Electronics, Fashion, etc." value="{{ old('name', $category->name) }}" required 
                ...
                <div class="mb-5">
                    ...
                    <textarea name="description" id="description" class="form-control border-2 shadow-none" 
                              ...
                              style="border-radius: 12px;">{{ old('description', $category->description) }}</textarea>
                    @error('description')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-flex gap-3">
                    <button type="submit" class="btn btn-success px-5 py-3 fw-bold shadow-sm" style="border-radius: 15px;">
